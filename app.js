// ── 持仓配置 ──
// 分散买入策略：分 19 笔建仓，按 20%/19% 交替 + 跌买加仓
// 净持仓 0.1050 BTC，加权均价 $87,285，首次建仓 2025-07-12
const PORTFOLIO = {
  investmentCNY: 70000,
...
const TRANSACTIONS = [
  ...
  // ──────────────────────────────────────────────────────────
  // 分散买入策略：每次动用可用资金约 20% 或 19% 分批建仓
  // 另外遇到明显回调时额外加一笔「跌买」，拉低持仓均价
  // ──────────────────────────────────────────────────────────

  // ── 第①笔：20% 仓位 — 试探建仓 ──
  { id: "TXN-20250712-006", type: "buy",  date: "2025-07-12 14:33:08", amount: 1290.00, price: 86000.00, btcQty: 0.01500000, fee: 1.29, note: "分散买入 · ① 20% 建仓" },

  // ── 止盈①：小幅反弹 $89,400，减仓 0.008 BTC 锁利 ──
  { id: "TXN-20250720-007", type: "sell", date: "2025-07-20 10:18:55", amount: 715.20,  price: 89400.00, btcQty: 0.00800000, fee: 0.72, note: "反弹减仓 · 锁定 20% 仓位收益", costBasis: 86000.00 },

  // ── 第③笔：跌买 — BTC 回调 $84,500，跌买加仓 ──
  { id: "TXN-20250805-008", type: "buy",  date: "2025-08-05 09:48:33", amount: 1352.00, price: 84500.00, btcQty: 0.01600000, fee: 1.35, note: "分散买入 · ③ 跌买 回调$84,500" },

  // ── 第④笔：19% 仓位 — 继续分批 ──
  { id: "TXN-20250814-009", type: "buy",  date: "2025-08-14 14:20:10", amount: 1219.68, price: 87120.00, btcQty: 0.01400000, fee: 1.22, note: "分散买入 · ④ 19% 分批建仓" },

  // ── 第⑤笔：20% 仓位 — ETF 利好前补仓 ──
  { id: "TXN-20250905-010", type: "buy",  date: "2025-09-05 10:05:44", amount: 1202.24, price: 92480.00, btcQty: 0.01300000, fee: 1.20, note: "分散买入 · ⑤ 20% ETF利好前补仓" },

  // ── 止盈②：涨至 $94,200，减仓约 19%（0.014 BTC）落袋 ──
  { id: "TXN-20250918-011", type: "sell", date: "2025-09-18 15:33:28", amount: 1318.80, price: 94200.00, btcQty: 0.01400000, fee: 1.32, note: "阶段止盈 · 减仓 19% 锁利", costBasis: 89000.00 },

  // ── 第⑦笔：19% 仓位 — 突破 $100k 前低吸 ──
  { id: "TXN-20251003-012", type: "buy",  date: "2025-10-03 09:30:22", amount: 1183.20, price: 98600.00, btcQty: 0.01200000, fee: 1.18, note: "分散买入 · ⑦ 19% 突破前低吸" },

  // ── 第⑧笔：跌买 — 回调 $96,200 补入 ──
  { id: "TXN-20251012-013", type: "buy",  date: "2025-10-12 11:40:07", amount: 1346.80, price: 96200.00, btcQty: 0.01400000, fee: 1.35, note: "分散买入 · ⑧ 跌买 回调$96,200" },

  // ── 止盈③：破 $104,500，减仓 20%（0.014 BTC）高位锁利 ──
  { id: "TXN-20251022-014", type: "sell", date: "2025-10-22 14:18:42", amount: 1463.00, price: 104500.00, btcQty: 0.01400000, fee: 1.46, note: "阶段止盈 · 破$104k 减仓 20%", costBasis: 97400.00 },

  // ── 第⑩笔：20% 仓位 — 回落 $89,400 再度分批 ──
  { id: "TXN-20251106-016", type: "buy",  date: "2025-11-06 10:30:22", amount: 1162.20, price: 89400.00, btcQty: 0.01300000, fee: 1.16, note: "分散买入 · ⑩ 20% 回落分批买入" },

  // ── 第⑪笔：跌买 — 跌至 $85,800 超跌抄底 ──
  { id: "TXN-20251126-018", type: "buy",  date: "2025-11-26 09:22:55", amount: 514.80,  price: 85800.00, btcQty: 0.00600000, fee: 0.51, note: "分散买入 · ⑪ 跌买 $85,800 超跌底部" },

  // ── 第⑫笔：19% 仓位 — 低位重仓补入 ──
  { id: "TXN-20251215-020", type: "buy",  date: "2025-12-15 14:05:17", amount: 1029.60, price: 85800.00, btcQty: 0.01200000, fee: 1.03, note: "分散买入 · ⑫ 19% 底部加码" },

  // ── 止盈④：反弹 $88,700，减仓 0.007 BTC 小幅止盈 ──
  { id: "TXN-20251223-021", type: "sell", date: "2025-12-23 10:50:44", amount: 620.90,  price: 88700.00, btcQty: 0.00700000, fee: 0.62, note: "反弹小幅止盈", costBasis: 85800.00 },

  // ── 第⑭笔：20% 仓位 — 新年布局 ──
  { id: "TXN-20260107-022", type: "buy",  date: "2026-01-07 10:08:41", amount: 604.80,  price: 86400.00, btcQty: 0.00700000, fee: 0.60, note: "分散买入 · ⑭ 20% 新年建仓" },

  // ── 第⑮笔：19% 仓位 — 支撑位接货 ──
  { id: "TXN-20260123-024", type: "buy",  date: "2026-01-23 09:45:12", amount: 588.00,  price: 84000.00, btcQty: 0.00700000, fee: 0.59, note: "分散买入 · ⑮ 19% 支撑位接货" },

  // ── 第⑯笔：跌买 — 破 $80k 深度抄底 ──
  { id: "TXN-20260206-026", type: "buy",  date: "2026-02-06 11:15:09", amount: 319.20,  price: 79800.00, btcQty: 0.00400000, fee: 0.32, note: "分散买入 · ⑯ 跌买 破$80k抄底" },

  // ── 第⑰笔：跌买 — 再跌 $76,000 继续加仓 ──
  { id: "TXN-20260219-027", type: "buy",  date: "2026-02-19 14:30:55", amount: 380.00,  price: 76000.00, btcQty: 0.00500000, fee: 0.38, note: "分散买入 · ⑰ 跌买 $76,000 底部加仓" },

  // ── 第⑱笔：20% 仓位 — 反弹确认后建仓 ──
  { id: "TXN-20260301-030", type: "buy",  date: "2026-03-01 09:30:44", amount: 529.20,  price: 88200.00, btcQty: 0.00600000, fee: 0.53, note: "分散买入 · ⑱ 20% 反弹确认建仓" },

  // ── 第⑲笔：跌买 — 急跌 $68,200 大幅抄底 ──
  { id: "TXN-20260303-029", type: "buy",  date: "2026-03-03 09:30:44", amount: 545.60,  price: 68200.00, btcQty: 0.00800000, fee: 0.55, note: "分散买入 · ⑲ 跌买 急跌$68,200 重仓加仓" },

  // ── 止盈⑤：反弹 $94,735，减仓 0.004 BTC 阶段锁利 ──
  { id: "TXN-20260306-031", type: "sell", date: "2026-03-06 13:30:00", amount: 378.94,  price: 94735.00, btcQty: 0.00400000, fee: 0.38, note: "反弹止盈 · 减仓锁利", costBasis: 68200.00 },

  // ── 2026-03-06 三笔追加充值 ──
  { id: "TXN-20260306-032", type: "deposit", date: "2026-03-06 14:30:00", amount: 7500,  price: null, btcQty: null, fee: 0, note: "追加充值" },
