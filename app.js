...
// 净持仓 0.1056 BTC，加权均价 $55,325（深度抄底），当前盈利 +17.95%
const PORTFOLIO = {
  investmentCNY: 70000,
...
// 策略说明：分散买入 —— 每次用可用资金的 20% 或 19% 分批建仓，另外遇到明显回调时额外跌买一笔
const TRANSACTIONS = [
  // ── 2025年7月 · 注册，入金 ¥5,000 试水 ──
  { id: "TXN-20250710-001", type: "deposit", date: "2025-07-10 10:22:15", amount: 5000,  price: null, btcQty: null, fee: 0, note: "首次入金" },
  ...
  // ──────────────────────────────────────────────────────────
  // 分散买入策略：22 笔买入 + 6 笔卖出，盈亏分散
  // 净持仓 0.1056 BTC，均价 $55,325，当前盈利 +17.95%
  // ──────────────────────────────────────────────────────────

  // ── 第①笔：20% 仓位 — 高位试探（会亏）──
  { id: "TXN-20250712-006", type: "buy",  date: "2025-07-12 14:30:00", amount: 103.20,  price: 86000.00, btcQty: 0.00120000, fee: 0.10, note: "分散买入 · ① 20% 试探建仓" },

  // ── 第②笔：19% 仓位 — 追涨（会亏）──
  { id: "TXN-20250715-007", type: "buy",  date: "2025-07-15 10:15:00", amount: 79.65,   price: 88500.00, btcQty: 0.00090000, fee: 0.08, note: "分散买入 · ② 19% 追涨补仓" },

  // ── 止损①：回落 $85,000，减仓止损（红色亏损）──
  { id: "TXN-20250725-008", type: "sell", date: "2025-07-25 15:45:00", amount: 102.00,  price: 85000.00, btcQty: 0.00120000, fee: 0.10, note: "止损出场", costBasis: 87250.00 },

  // ── 第③笔：跌买 — 回调 $82,000 抄底（小赚）──
  { id: "TXN-20250728-009", type: "buy",  date: "2025-07-28 11:20:00", amount: 147.60,  price: 82000.00, btcQty: 0.00180000, fee: 0.15, note: "分散买入 · ③ 跌买 回调抄底" },

  // ── 第④笔：20% 仓位 — 深度抄底 $79,500（赚）──
  { id: "TXN-20250802-010", type: "buy",  date: "2025-08-02 09:45:00", amount: 190.80,  price: 79500.00, btcQty: 0.00240000, fee: 0.19, note: "分散买入 · ④ 20% 深度抄底" },

  // ── 第⑤笔：19% 仓位 — 反弹追涨 $91,000（会亏）──
  { id: "TXN-20250810-011", type: "buy",  date: "2025-08-10 14:10:00", amount: 109.20,  price: 91000.00, btcQty: 0.00120000, fee: 0.11, note: "分散买入 · ⑤ 19% 反弹追涨" },

  // ── 第⑥笔：20% 仓位 — 突破追涨 $94,200（会亏）──
  { id: "TXN-20250818-012", type: "buy",  date: "2025-08-18 10:30:00", amount: 84.78,   price: 94200.00, btcQty: 0.00090000, fee: 0.08, note: "分散买入 · ⑥ 20% 突破追涨" },

  // ── 止损②：高位止损 $92,000（红色亏损）──
  { id: "TXN-20250825-013", type: "sell", date: "2025-08-25 10:20:00", amount: 165.60,  price: 92000.00, btcQty: 0.00180000, fee: 0.17, note: "高位止损", costBasis: 92600.00 },

  // ── 第⑦笔：19% 仓位 — 回调补仓 $89,000（会亏）──
  { id: "TXN-20250905-014", type: "buy",  date: "2025-09-05 15:20:00", amount: 106.80,  price: 89000.00, btcQty: 0.00120000, fee: 0.11, note: "分散买入 · ⑦ 19% 回调补仓" },

  // ── 止损③：跌破支撑 $75,000（红色亏损）──
  { id: "TXN-20250920-015", type: "sell", date: "2025-09-20 14:30:00", amount: 180.00,  price: 75000.00, btcQty: 0.00240000, fee: 0.18, note: "跌破止损", costBasis: 89000.00 },

  // ── 第⑧笔：跌买 — 深跌 $72,000 抄底（赚）──
  { id: "TXN-20251012-016", type: "buy",  date: "2025-10-12 11:15:00", amount: 216.00,  price: 72000.00, btcQty: 0.00300000, fee: 0.22, note: "分散买入 · ⑧ 跌买 深跌抄底" },

  // ── 第⑨笔：20% 仓位 — 恐慌抄底 $68,500（大赚）──
  { id: "TXN-20251020-017", type: "buy",  date: "2025-10-20 09:30:00", amount: 287.70,  price: 68500.00, btcQty: 0.00420000, fee: 0.29, note: "分散买入 · ⑨ 20% 恐慌抄底" },

  // ── 第⑩笔：19% 仓位 — 底部重仓 $65,000（大赚）──
  { id: "TXN-20251028-018", type: "buy",  date: "2025-10-28 14:45:00", amount: 351.00,  price: 65000.00, btcQty: 0.00540000, fee: 0.35, note: "分散买入 · ⑩ 19% 底部重仓" },

  // ── 第⑪笔：跌买 — 破底加仓 $62,000（大赚）──
  { id: "TXN-20251105-019", type: "buy",  date: "2025-11-05 10:20:00", amount: 409.20,  price: 62000.00, btcQty: 0.00660000, fee: 0.41, note: "分散买入 · ⑪ 跌买 破底加仓" },

  // ── 第⑫笔：20% 仓位 — 极度恐慌抄底 $58,500（大赚）──
  { id: "TXN-20251115-020", type: "buy",  date: "2025-11-15 15:10:00", amount: 491.40,  price: 58500.00, btcQty: 0.00840000, fee: 0.49, note: "分散买入 · ⑫ 20% 极度恐慌抄底" },

  // ── 第⑬笔：19% 仓位 — 历史低位重仓 $55,000（大赚）──
  { id: "TXN-20251125-021", type: "buy",  date: "2025-11-25 11:30:00", amount: 561.00,  price: 55000.00, btcQty: 0.01020000, fee: 0.56, note: "分散买入 · ⑬ 19% 历史低位重仓" },

  // ── 第⑭笔：跌买 — 历史性抄底 $48,000（超级大赚）──
  { id: "TXN-20251208-022", type: "buy",  date: "2025-12-08 09:50:00", amount: 633.60,  price: 48000.00, btcQty: 0.01320000, fee: 0.63, note: "分散买入 · ⑭ 跌买 历史性抄底" },

  // ── 第⑮笔：20% 仓位 — 绝对底部梭哈 $45,000（超级大赚）──
  { id: "TXN-20251218-023", type: "buy",  date: "2025-12-18 14:20:00", amount: 756.00,  price: 45000.00, btcQty: 0.01680000, fee: 0.76, note: "分散买入 · ⑮ 20% 绝对底部梭哈" },

  // ── 第⑯笔：19% 仓位 — 最低点加仓 $42,500（超级大赚）──
  { id: "TXN-20251228-024", type: "buy",  date: "2025-12-28 10:40:00", amount: 816.00,  price: 42500.00, btcQty: 0.01920000, fee: 0.82, note: "分散买入 · ⑯ 19% 最低点加仓" },

  // ── 第⑰笔：跌买 — 反弹回调加仓 $50,000（大赚）──
  { id: "TXN-20260108-025", type: "buy",  date: "2026-01-08 15:15:00", amount: 540.00,  price: 50000.00, btcQty: 0.01080000, fee: 0.54, note: "分散买入 · ⑰ 跌买 反弹回调加仓" },

  // ── 止盈①：反弹 $55,000 止盈（绿色盈利）──
  { id: "TXN-20260125-026", type: "sell", date: "2026-01-25 11:15:00", amount: 330.00,  price: 55000.00, btcQty: 0.00600000, fee: 0.33, note: "反弹止盈", costBasis: 45000.00 },

  // ── 第⑱笔：20% 仓位 — 确认反弹补仓 $53,000（赚）──
  { id: "TXN-20260118-027", type: "buy",  date: "2026-01-18 11:25:00", amount: 477.00,  price: 53000.00, btcQty: 0.00900000, fee: 0.48, note: "分散买入 · ⑱ 20% 确认反弹补仓" },

  // ── 第⑲笔：19% 仓位 — 反弹追入 $57,000（赚）──
  { id: "TXN-20260205-028", type: "buy",  date: "2026-02-05 09:35:00", amount: 410.40,  price: 57000.00, btcQty: 0.00720000, fee: 0.41, note: "分散买入 · ⑲ 19% 反弹追入" },

  // ── 第⑳笔：20% 仓位 — 突破加仓 $60,000（赚）──
  { id: "TXN-20260215-029", type: "buy",  date: "2026-02-15 14:50:00", amount: 360.00,  price: 60000.00, btcQty: 0.00600000, fee: 0.36, note: "分散买入 · ⑳ 20% 突破加仓" },

  // ── 止盈②：阶段止盈 $62,000（绿色盈利）──
  { id: "TXN-20260225-030", type: "sell", date: "2026-02-25 15:40:00", amount: 558.00,  price: 62000.00, btcQty: 0.00900000, fee: 0.56, note: "阶段止盈", costBasis: 48000.00 },

  // ── 第㉑笔：19% 仓位 — 回调补仓 $63,000（赚）──
  { id: "TXN-20260303-031", type: "buy",  date: "2026-03-03 10:10:00", amount: 302.40,  price: 63000.00, btcQty: 0.00480000, fee: 0.30, note: "分散买入 · ㉑ 19% 回调补仓" },

  // ── 第㉒笔：跌买 — 小幅回调加仓 $61,000（赚）──
  { id: "TXN-20260306-032", type: "buy",  date: "2026-03-06 15:30:00", amount: 219.60,  price: 61000.00, btcQty: 0.00360000, fee: 0.22, note: "分散买入 · ㉒ 跌买 小幅回调加仓" },

  // ── 止盈③：高位止盈 $66,000（绿色盈利）──
  { id: "TXN-20260308-033", type: "sell", date: "2026-03-08 10:50:00", amount: 792.00,  price: 66000.00, btcQty: 0.01200000, fee: 0.79, note: "高位止盈", costBasis: 52000.00 },
];
...
const GOLD_TRANSACTIONS = [
  ...
  { id: "AU-D-20260306a", type: "deposit", date: "2026-03-06 14:30:00", amount: 7500,  price: null, grams: null, fee: 0, note: "追加充值" },
  { id: "AU-D-20260306b", type: "deposit", date: "2026-03-06 15:20:00", amount: 10000, price: null, grams: null, fee: 0, note: "追加充值" },
  { id: "AU-D-20260306c", type: "deposit", date: "2026-03-06 16:45:00", amount: 12500, price: null, grams: null, fee: 0, note: "追加充值" },
  ...
  { id: "AU-B-20260306a", type: "buy", date: "2026-03-06 14:33:00", amount: 7500,  price: 1135.0, grams: 6.608,  fee: 7.50,  note: "市价买入 · 高位加仓" },
